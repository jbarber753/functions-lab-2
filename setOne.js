...
const arrowFunc = (x, y) => console.log(`The first parameter is ${x}. The second parameter is ${y}.`)
...
const greetingCallback = (fullName) => console.log(`Hello, my name is ${fullName}`);

// INVOKE 'GREETING FUNCTION' HERE

greeting(`Inigo`, `Montoya`, greetingCallback)
...
const priceCallback = param => console.log(`The new array plus tax is ${param}`);
pricesPlusTax(prices, priceCallback);
